...
app.post('/chat', async (req, res) => {
  try {
    ...
    const systemMessage = {
      role: 'system',
      content: "If the user mentions encountering fake news, provide multiple ethical ways they can take action. Suggest verifying sources, reporting to authorities, educating others, and promoting media literacy give in 3 lines only."
    };
